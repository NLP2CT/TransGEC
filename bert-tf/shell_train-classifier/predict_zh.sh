# --- predict --- 
# UN English->Chinese corpus only Chinese side, remember add any label to Chinese side for classfy. 
# The text file name should be test.shuf, eg. /Your-path/UN-Chinese-target-side/test.shuf

BERT_BASE_DIR=/Your-path/chinese_L-12_H-768_A-12
DATA_DIR=/Your-path/train_data-zh
DATA=/Your-path/UN-Chinese-target-side
...
UDA_VISIBLE_DEVICES=0 python $ROOT/tensor_bert/bert/run_classifier.py \
  ...
  --init_checkpoint=/Your-path/out-zh-model/model.ckpt-xxx \
