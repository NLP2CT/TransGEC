...
class TranlationeseProcessor(DataProcessor):
  """Processor for the txt data set."""

  def get_train_examples(self, data_dir):
    """See base class."""
    file_path = os.path.join(data_dir, "train.shuf")
    f = open(file_path, 'r')
    train_data = []
    index = 0
  ...
  def get_dev_examples(self, data_dir):
    """See base class."""
    file_path = os.path.join(data_dir, "dev.shuf")
    f =open(file_path, 'r')
  ...
  def get_test_examples(self, data_dir):
    """See base class."""
    file_path = os.path.join(data_dir, "test.shuf")
    f =open(file_path, 'r')
  ...
  def get_labels(self):
    """0 for oringinal; 1 for translationese """
    return ["0", "1"]
...
def main(_):
  ...
  processors = {
      ...
      "mrpc": MrpcProcessor,
      "xnli": XnliProcessor,
      "translationese":TranlationeseProcessor,
  }
